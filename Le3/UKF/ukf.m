function [x,S]=ukf(fstate,x,S,hmeas,z,Qs,Rs,kk)
...
[x1,X1,S1,X2] = ut(fstate,X,Wm,Wc,L,Qs,kk);  % unscented transformation of process

[z1,~,S2,Z2] = ut(hmeas,X1,Wm,Wc,m,Rs,kk);   % unscented transformation of measurments
...
function [y,Y,S,Y1]=ut(f,X,Wm,Wc,n,Rs,t)
