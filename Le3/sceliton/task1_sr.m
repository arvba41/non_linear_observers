...
nexttile();
plot( data.t', [xhatEKF_opt(1,:)', xhatEKF(1,:)']); hold on
plot( data.t', data.x(1,:)','--','Color','k');
...
nexttile();
plot( data.t', [xhatEKF_opt(2,:)', xhatEKF(2,:)']); hold on
plot( data.t', data.x(2,:)','--','Color','k');
xlabel('$t$ [s]','Interpreter','latex');
...
nexttile();
plot( data.t', 180 / pi * [xhatEKF_opt(3,:)', xhatEKF(3,:)']); hold on
plot( data.t', 180 / pi * data.x(3,:)','--','Color','k');
xlabel('$t$ [s]','Interpreter','latex');
...
% title('Estimation error','Interpreter');
box off
